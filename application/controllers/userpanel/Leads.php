...
class Leads extends CI_Controller {
    ...
    public function list(){
        ...
        $this->load->view('userpanel/dashboard.php',$data); 
    ...
    public function add() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if(!empty($followup)) {
                $usersession_id = $this->session->userdata('usersession_id');

                $datas = array('lead_id' => $saved, 'followup_id' => $followup, 'followup_text' => $followup_dis, 'followup_date' => $date, 'created_by' => $usersession_id, 'create_date' => $create_date);
    ...
    {      
        ...
        $this->load->view('userpanel/followup/edit.php',$data);         
    } 
    ...
    {        
        ...
        try {
            ...
            foreach ($allDataInSheet as $value) {
                ...
                if(!empty($value['P'])) { $c['email']            = $value['P']; }
