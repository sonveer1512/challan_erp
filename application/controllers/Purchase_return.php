...
class Purchase_return extends CI_Controller
{
	...
	*/
	...
	public function getBarcodeProducts($term,$warehouse_id){
		$data = $this->purchase_return_model->getBarcodeProducts2($term,$warehouse_id);
		echo json_encode($data);
	}
 	 public function allpro($term){
		$data = $this->purchase_return_model->getallpro($term);
		echo json_encode($data);
	}
	...
	*/
	...
	public function getProductUseCode($product_id){
		...
		$data = $this->purchase_return_model->getProductUseCode2($product_id);
	...
	public function getProductUseCode2($product_id,$warehouse_id){
