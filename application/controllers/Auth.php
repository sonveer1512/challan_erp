	...
	public function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				$data = $this->ion_auth_model->allReports();
				$data['challan'] = $this->challan_model->getQuotation();
				$data['inward'] = $this->challan_model->getQuotationtypewise('inward');
				$data['outward'] = $this->challan_model->getQuotationtypewise('outward');
				$data['sitewisechallan'] = $this->challan_model->getdashboardsiteQuotation();
				$data['transportwisechallan'] = $this->challan_model->getdashboardtransportQuotation();
