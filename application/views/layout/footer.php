  <footer class="main-footer">
      ...
      <strong><?php echo $this->lang->line('dashboard_copyright'); ?> &copy; <?php echo date('Y'); ?> <a href="https://axepertexhibits.com/" target="_blank">Axepert Exhibits Pvt Ltd</a>.</strong> All <?php echo $this->lang->line('dashboard_rights_reserved'); ?>
  </footer>
  <!-- ./wrapper -->
  <!-- Control Sidebar -->
