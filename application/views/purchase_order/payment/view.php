    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('purchase_order'); ?>">Purchase</a></li>
	      	...
	      	<div class="col-md-12">
		        <div class="box box-info">
		            <div class="box-header with-border">
		              ...
		              <a class="btn btn-sm btn-info pull-right" style="margin: 10px" href="<?php echo base_url('purchase_order/add');?>" title="Add New Purchase"> Add Payment </a>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
