    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('purchase_order'); ?>"><?php echo $this->lang->line('header_purchase'); ?></a></li>
		        ...
		        <div class="box">
		            ...
		            <div class="box-header with-border ">
		              ...
		              <?php if($data[0]->paid_amount == 0.00){ ?>
		              	<a class=" btn btn-info pull-right" href="<?php echo base_url('purchase_order/payment/'); ?><?php echo $data[0]->purchase_id; ?>" title="Add Payment">Pay Now</a>
			            ...
			            <div class="col-sm-12">
			            	<div class="buttons">
								<div class="btn-group btn-group-justified">
									<div class="btn-group">
										<a class="tip btn btn-info tip" href="<?php echo base_url('purchase_order/email/');?><?php echo $data[0]->purchase_id; ?>" title="Email">
											<i class="fa fa-envelope-o"></i>
											<span class="hidden-sm hidden-xs"><?php echo $this->lang->line('company_setting_email'); ?></span>
										</a>
									</div>
									<div class="btn-group">
										<a class="tip btn btn-success" href="<?php echo base_url('purchase_order/pdf/');?><?php echo $data[0]->purchase_id; ?>" title="Download as PDF" target="_blank">
											<i class="fa fa-download"></i>
											<span class="hidden-sm hidden-xs"><?php echo $this->lang->line('product_alert_pdf'); ?></span>
										</a>
									</div>
									<div class="btn-group">
										<a class="tip btn btn-warning tip" href="<?php echo base_url('purchase_order/edit/'); ?><?php echo $data[0]->purchase_id; ?>" title="Edit">
											<i class="fa fa-edit"></i>
