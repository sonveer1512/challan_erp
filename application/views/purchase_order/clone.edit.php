        ...
        <div class="row">
          ...
          <div class="span12">          
            ...
            <div class="widget-content">  <span style="color:blue;" id="success"><?php if(isset($err)){echo $err;}  ?></span>                                             
                <form id="edit-profile" method="post" class="form-horizontal" action="<?php echo base_url('purchase_order/edit_purchase');?>">
                    <fieldset>   
                      <br> 
...
$(document).ready(function(){
    ...
    $('#product').keyup(function(){
      ...
      if(code){
        $.ajax({
          url:"<?php echo base_url(); ?>index.php/purchase_order/getAutoCodeName/"+code+"/"+search_option,
          type: "GET",
          dataType: "html",
    ...
    function addRow(){
          ...
          //alert(search_option);
          $.ajax({
              url: "<?php echo base_url('index.php/purchase_order/getProduct') ?>/"+code+"/"+search_option,
              type: "GET",
              dataType: "JSON",
              success: function(data){
                //alert(data);
...
<script>
  /*$(document).ready(function(){
    $('#autoproduct ul li').click(function(){
      ...
      //alert(search_option);
      $.ajax({
          url: "<?php echo base_url('index.php/purchase_order/getProduct') ?>/"+code,
          type: "GET",
          dataType: "JSON",
          success: function(data){
            //alert(data[0].product_id);
