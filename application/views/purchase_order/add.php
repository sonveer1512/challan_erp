...
.tooltip:hover .tooltiptext {
    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li class="active"><?php echo $this->lang->line('purchase_add_purchase'); ?> Order</li>
        </ol>
      </h5>    
    </section>
  ...
  <!-- Main content -->
    <section class="content">
      <div class="row">
      <!-- right column -->
        <form role="form" id="form" method="post" action="<?php echo base_url('purchase_order/addPurchase');?>">
        <div class="col-sm-12">
          <?php 
          ...
          <div class="alert alert-warning alert-dismissible">
            ...
            <!-- <h4><i class="icon fa fa-warning"></i> Alert!</h4> -->
                ...
                <a href="<?php echo base_url('purchase_orderr/add');?>" class="btn btn-default bg-white text-red">Add Purchaser</a>  
          </div>
          <?php
              } 
          ?>
          ...
          <div class="box">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="reference_no" name="reference_no" value="CRK-<?php echo $no;?>" readonly>
            ...
            <div class="box-body billing-data">
              <div class="col-sm-12">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><b>Billing Address ( Company Address )</b> <a href="" data-toggle="modal" data-target="#change_shipping_address">Change</a></h5>
                    ...
                    <input type="hidden" name="billing_address2" id="billing_address2" value="<?php echo $company[0]->street; ?>">
                    <input type="hidden" name="billing_city2" id="billing_city2" value="<?php echo $company[0]->city_name; ?>">
                    <input type="hidden" name="billing_state2" id="billing_state2" value="<?php echo $company[0]->state_name; ?>">
                    <input type="hidden" name="billing_country2" id="billing_country2" value="<?php echo $company[0]->country_name; ?>">
                  </div>
            ...
            <div class="box-header with-border supplier" style="display: none">
              <h3 class="box-title">Supplier & Transportation Details</h3>
              <span class="pull-right-container">
                <i class="glyphicon glyphicon-chevron-right pull-right"></i>
              </span>
            </div>
            <div class="box-body supplier-data" style="display: none">
              <div class="col-sm-12">
                <div class="row">
                  <div class="col-sm-3">
                    <div class="form-group">
            ...
            <div class="box-header with-border requirement">
              <h3 class="box-title">Requirements</h3>
              <span class="pull-right-container">
                <i class="glyphicon glyphicon-chevron-right pull-right"></i>
              </span>
            </div>
            <div class="box-body requirement-data" style="">
              <div class="col-sm-12">
                <div class="row">     
                  <div class="col-sm-12">
                    <div class="form-group">
                      <table class="table items table-striped table-bordered table-condensed table-hover outer-scroll" width="50%">
                          <tr>
                            <th>S. No.</th>
                            <th>Item Name</th>
                            <th>Required Quantity</th>
                            <th style="background-color: #b9e4f2">Available Quantity</th>
                            <th>Action</th>
                          </tr>
                          <?php 
                          $i=0; foreach($requirements as $value) { $i++; ?>
                            <tr>
                              <td><?=$i?></td>
                              <td>
                                  <div class="tooltip"><?=$value->name?>
                                    <span class="tooltiptext">
                                      <?php 
                                        $pro_req = $this->requirement_model->getproductrequirementforpurchaseorder($value->product_id);
                                        foreach($pro_req as $pro_reqval) {
                                          echo $pro_reqval->warehouse_name.": ".$pro_reqval->quantity."<br>";
                                        }  
                                      ?>
                                    </span>
                                  </div>
                              ...
                              <td style="background-color: #b9e4f2"><span style="color: green;"><?=$value->available_quantity?></span></td>
                              <td><a class="addrequire btn btn-info" data-id="<?=$value->product_id?>" rol="button">Add</a></td>
                            </tr>
                          <?php } ?>
                      </table>
                    </div>
  ...
  $('#btn_shipping_change').click(function(){
    $.ajax({
      ...
      success : function(data){
        $('#billing_address').text($("#address").val());
        $('#billing_city').text(data.city);
        $('#billing_state').text(data.state);
        $('#billing_country').text(data.country);
        $('#billing_address2').val($("#address").val());
        $('#billing_city2').val(data.city);
        $('#billing_state2').val(data.state);
        $('#billing_country2').val(data.country);
...
<script>
 $(document).ready(function(){
    ...
    $('.addrequire').on('click', function(e) {
      var id = $(this).data("id");
      $.ajax({
        url:"<?php echo base_url('purchase_order/getProductUseCode') ?>/"+id,
        type:"GET",
        dataType:"JSON",
        success: function(data){  
          add_row(data);
  ...
  $(document).ready(function(){
    ...
    $("#warehouse").change(function(event){
      ...
      if(warehouse==""){
        ...
        $.ajax({
          url: "<?php echo base_url('purchase_order/getWarehouseState') ?>/"+warehouse,
          type: "GET",
          dataType: "json",
          success: function(data){
...
<script>
  $(document).ready(function(){
    ...
    /*$('#warehouse').change(function(){
      ...
      $.ajax({
          url: "<?php //echo base_url('purchase_order/getSuppliersData') ?>/"+customer_id,
          type: "POST",
          dataType: "JSON",
          data:{
                '<?php //echo $this->security->get_csrf_token_name(); ?>' : '<?php //echo $this->security->get_csrf_hash(); ?>'
