...
<body>
	...
	<table width="100%" border="1" cellspacing="0" style="border: 0px solid black; border-collapse: collapse;" class="table" cellpadding="2">
			<tr>
				<td colspan="14" style="border: 0px;text-align: center;">Purchase Order</td>
			</tr>

			<tr>
		        <td colspan="2" style="border-right: 0px;">
		        	<?php if(isset($company[0]->logo)){?>
						<img src="<?php echo base_url();?><?php echo $company[0]->logo;?>" width="120px;" style="float: left">	
					<?php }else{?>
						<img src="<?php echo base_url();?>/assets/images/logo.png;?>" width="120px;">
					<?php } ?>
		        </td>
		        <td colspan="12" style="border-left: 0px;">
		            <b style="font-size: 16px;"><?php if(isset($company[0]->name)){echo $company[0]->name;}?></b><br>
		...
		<!-- <tr style="font-size: 13px;">
			<td valign="top" colspan="7" style="font-size: 13px;">
				Delivery note<br>
		...
		<tr>
			<td valign="top" rowspan="4" style="text-align:left;font-size: 13px;" colspan="6">
				<b>Supplier</b><br>
				<?php if(isset($data[0]->supplier_company_name)){echo $data[0]->supplier_company_name;} ?><br><br>
		...
		<tr>
			<td valign="top" colspan="8" style="font-size: 13px;">
				Purchase Order: #<span style="font-size: 13px;font-weight:bold"><?php if(isset($data[0]->invoice_no)){echo $data[0]->invoice_no;}?></span> <br> &nbsp;
			</td>
		</tr>
		<tr>
			<td valign="top" colspan="8" style="font-size: 13px;">
				Dated: <span style="font-size: 13px;font-weight:bold"><?php if(isset($data[0]->date)){echo date("d-m-Y", strtotime($data[0]->date));}?></span>	 <br>	&nbsp;		
			</td> 
		</tr>
		<tr>
			<td valign="top" colspan="8" style="font-size: 13px;">
				...
				<p style="font-size: 13px;">
					...
					<?php if(isset($data[0]->address)){echo $data[0]->address; }?><br>
					<?php if(isset($data[0]->city)){echo $data[0]->city; }?><br>
					<?php if(isset($data[0]->state)){echo $data[0]->state; }?>
					<br> &nbsp;
				</p>
			</td> 
		</tr>
		<!-- <tr>
			<td valign="top" colspan="8" style="height: 60px;font-size: 13px;">
				E-way Bill<br>
		...
		<tr>
			...
			<tr>
				...
				<td class="fontS"><?php echo $value->name; ?> <br>(<?php echo $value->code; ?>)</td>
				<td class="fontS"><?php echo $value->hsn_sac_code; ?></td>
				<td class="fontS"><?php echo $value->unit; ?></td>
        ...
        <tr>
        	...
        	<td colspan="14" style="height: 60px;border-bottom: 0px;font-size: 13px;">Terms & Condition <b><?php if(isset($company[0]->terms_condition)){echo $company[0]->terms_condition;}?></b></td>
        </tr>
        <!-- <tr>
