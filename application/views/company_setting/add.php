            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      <label for="street">Work Address <span class="validation-color">*</span></label>
                      <input type="text" class="form-control" id="work_address" name="work_address" value="<?php if(isset($data[0]->work_address)){ echo $data[0]->work_address; }?>">
                      <span class="validation-color" id="err_street"><?php echo form_error('work_address'); ?></span>
                    </div>
