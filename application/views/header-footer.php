<?php $data['comp'] = $this->company_setting_model->getData(); ?>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="http://vgeekers.com" target="_blank">VGeekers</a>.</strong> All rights
