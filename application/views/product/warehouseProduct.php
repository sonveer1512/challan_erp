      ...
      <!-- right column -->
        ...
        <div class="box">
          ...
          ?>
              ...
              <a class="btn btn-sm btn-success pull-right btn-flat disabled" style="margin-right: 10px" href="<?php echo base_url('product/export');?>">Export </a>
        ...
        ?>
              ...
              <a class="btn btn-sm btn-success pull-right btn-flat " style="margin-right: 10px" href="<?php echo base_url('product/export');?>">Export </a>
                ...
                <tbody>
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <?php
                      /*
                      <td width="5%"><img src="<?php if($row['image'] == null) {echo base_url('assets/images')."/no_image.png";}else{echo $row['image'];} ?>" width="100%" height="30px;"></td>
                        */
                        ?>
