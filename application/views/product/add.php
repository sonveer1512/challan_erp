                ...
                <form role="form" id="form" method="post" action="<?php echo base_url('product/addProduct');?>" encType="multipart/form-data">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="code" name="code" value="<?php echo $item_code ?>" >
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input class="form-control" id="length" name="length" value="<?php echo set_value('length'); ?>">
					...
					<input class="form-control" name="product" id="product" type="hidden" value="product">
                <div class="col-sm-12">
