              ...
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('product/editProduct');?>" encType="multipart/form-data">
                 <?php foreach($data as $row){?>
                  ...
                  <div class="form-group">
                      <label for="note">Length </label>
                      <input class="form-control" id="length" name="length" value="<?php echo $row->length;?>">
                      <span class="validation-color" id="err_length"><?php echo form_error('length'); ?></span>
                    </div>
