...
<html lang="en">
    <head>
        ...
        <style type="text/css">
            ...
            .main-header { padding: 10px 0 5px;background-color: #f07b20; min-height:50px;}
            .logo-lg img {width: 85%;}
            .imgresponsive{ width:100%; display:block; height:auto;}
            .space30{ padding:40px 0}
            .font-size2{font-size:20px;}
            .btn2{margin-top:20px; background:#f07b20; border:1px solid #f07b20; transition: all 0.5s ease;}
            .btn2:hover{background:#f07b20;}
        </style>
    </head>
    <body>
        ...
        <div class="container">
            <div class="row" style="place-content: center;">
                <div class="space30">
                    <img src="<?=base_url()?>/assets/images/errorimg.png" class="img-responsive margin-auto" />
                </div>
            </div>
            <div class="row" style="place-content: center;">    
