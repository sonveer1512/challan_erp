  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b><?php echo $this->lang->line('dashboard_version'); ?></b> 2.7
    </div>
    <strong><?php echo $this->lang->line('dashboard_copyright'); ?> &copy; <?php echo date('Y'); ?> <a href="http://vakratundasystem.in/" target="_blank">Vakratunda System Pvt Ltd</a>.</strong> All <?php echo $this->lang->line('dashboard_rights_reserved'); ?>
  </footer>
<!-- ./wrapper -->
<!-- Control Sidebar -->
