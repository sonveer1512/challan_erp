            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label for="vat_no">CIN No
                        <span class="validation-color"></span>
                    </label>
                    <input type="text" class="form-control" id="cin_no" name="cin_no" value="<?php echo set_value('cin_no'); ?>">
                    <span class="validation-color" id="err_msme_no"><?php echo form_error('msme_no'); ?></span>
                  </div>

                  <div class="form-group">
                    <label for="vat_no">MSME No 
                        <span class="validation-color"></span>
                    </label>
                    <input type="text" class="form-control" id="msme_no" name="msme_no" value="<?php echo set_value('msme_no'); ?>">
                    <span class="validation-color" id="err_msme_no"><?php echo form_error('msme_no'); ?></span>
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mobile" name="mobile" max-length="10" value="<?php echo set_value('mobile'); ?>">
