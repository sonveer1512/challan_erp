      ...
      <!-- right column -->
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('customer/addCustomer');?>" enctype="multipart/form-data">
                <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mobile" max-length="10" name="mobile" value="<?php echo set_value('mobile'); ?>">
