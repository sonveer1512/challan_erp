    ...
    <section class="content">
      ...
      <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('customer/editCustomer');?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <label for="email"><!-- email --> 
                         Image <span class="validation-color">*</span></label>
