            ...
            <div class="box-body general-data" style="">
              <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" id="category" name="category" style="width: 100%;">
                        ...
                        <?php  foreach ($category as $cat) { ?>
                          <option value='<?php echo $cat->category_id ?>' <?php if($cat->category_id == $data[0]->category_id){echo "selected";} ?>><?php echo $cat->category_name ?></option>
                        <?php } ?>
                      </select>
				 ...
				 <div class="col-sm-3">
                    <div class="form-group">
                      <?php echo $data[0]->subcategory_id;?>
                      ...
                      <select class="form-control select2" id="subcategory" name="subcategory" style="width: 100%;">
                        ...
                        <?php  foreach ($subcategory as $sub) { ?>
                          <option value='<?php echo $sub->subcategory_id ?>' <?php if($sub->sub_category_id == $data[0]->subcategory_id){echo "selected";} ?>><?php echo $sub->sub_category_name ?></option>
                        <?php } ?>
                      </select>
                   ...
                   <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      </label><a href="" data-toggle="modal" data-target="#brand_model" class="pull-right">+ Add New Sub-Sub Category</a>
                      <select class="form-control select2" id="subsubcat" name="subsubcat" style="width: 100%;">
                        <option value="0"><?php echo $this->lang->line('product_select'); ?></option>
                        <?php  foreach ($brand as $br) { ?>
                          <option value='<?php echo $br->id ?>' <?php if($br->sub_category_id == $row->id){echo "selected";} ?>><?php echo $br->subsub_category ?></option>
                        <?php } ?>
                      </select>
                      <span class="validation-color" id="err_category"><?php echo form_error('category'); ?></span>
                    </div>
