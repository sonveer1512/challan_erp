	      	...
	      	<div class="col-md-12">
		        <div class="box">
		            ...
		            <div class="box-header with-border ">
                      ...
                      elseif(($data[0]->paid_amount) < ($data[0]->total-(int)filter_var($data[0]->flat_discount, FILTER_SANITIZE_NUMBER_INT))){ ?>
                          <a class=" btn btn-info pull-right" href="<?php echo base_url('purchase/payment/'); ?><?php echo $data[0]->purchase_id ; ?>" title="Add Payment">Pay Now</a>
                      <?php }else{ ?>
		            ...
		            <!-- /.box-header -->
                  <div class="col-sm-9">
				            		<b><h4>Refrence No - <?php echo $data[0]->reference_no; ?></h4></b>
                                  </div>
                  
                        <div class="col-sm-3">
                          <b style="float:right;"><h4>Date - <b><?php echo $data[0]->date; ?></b></h4></b>
		            ...
		            <div class="box-body">
		            	...
		            	<div class="col-sm-12 well well-sm">
                          ...
                          <div class="col-sm-4">
			            		<div class="col-sm-2">
			            			<i class="fa fa-3x fa fa-info-circle padding010 text-muted"></i>
			            		</div>
			            		<div class="col-sm-10">
			            			<b><h4>Customer Name - <?php echo $data[0]->customer_name; ?></h4></b>
				            	
				            		Customer HSN Code - <?php echo $data[0]->hsn_code; ?>
				            		<br>
				            		Customer Address - <?php echo $data[0]->address; ?>
				            		<br>
				            		Customer GSTNO - <?php echo $data[0]->gst_no; ?>
				            		<br>
				            		Discount - <?php echo $data[0]->disc_product; ?>
				            		<br>
				            		Payment Mode - <?php echo $data[0]->payment_mode; ?>
                                  <br>
				            		Category - <?php echo $data[0]->category; ?>
                                  <br>
				            		For Site - <?php echo $data[0]->for_site; ?>
                                   <br>
				            		Advance Balance - <?php echo $data[0]->advance_balance; ?>
			            		</div>
			            	</div>
                      </div>
