                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?=base_url()?>challan/transport/<?=$row->vehicle_id?>"> <?php echo $row->vehicle_number ?> (<?php echo $row->driver_name ?>) </a>
                   	...
                   	<?php if(!empty($row->project_id)){ ?><?php $query = $this->db->query("SELECT * FROM project where id = $row->project_id");
                    ...
                    <?php if(!empty($row->transport_id)){ ?> <?php $query = $this->db->query("SELECT * FROM transport_pay where id = $row->transport_id");
						$result = $query->result_array(); ?>
                    <?php if(!empty($result)){ ?>
                        ...
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <?php if($row->type != 'inward') { ?>
                              ...
                              <li>
                                <a href="<?php echo base_url('challan/edit/'); ?><?php echo $row->id; ?>"><i class="fa fa-edit"></i>Edit Inward Challan</a>
                              </li>
                            <?php } ?>
