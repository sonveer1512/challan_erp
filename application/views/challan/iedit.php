...
?>
  ...
  <!-- Main content -->
    <section class="content">
      ...
      <!-- right column -->
        <div class="col-sm-12">
          <form role="form" id="form" method="post" action="<?php echo base_url('challan/editinwardChallan');?>">
            <div class="box">
              <div class="box-header with-border general">
                <h3 class="box-title">
                  <?php
                    ...
                    ?>
                    <input type="hidden" name="reference_no" value="<?php echo $no; ?>">
                </h3>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="site_contact_no" name="site_contact_no" value="<?=$data[0]->site_contact_no?>">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="transporter" name="transporter" value="<?=$data[0]->transporter?>">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="order_by" name="order_by" value="<?=$data[0]->order_by?>">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="dispatch_by" name="dispatch_by" value="<?=$data[0]->dispatch_by?>">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="dispatch_from" name="dispatch_from" value="<?=$data[0]->dispatch_to?>">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="dispatch_to" name="dispatch_to" value="<?=$data[0]->dispatch_from?>">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="loaded_by" name="loaded_by" value="<?=$data[0]->loaded_by?>">
                        </div>
                      </div>
                    </div>
                      ...
                      <table class="table items table-striped table-bordered table-condensed table-hover product_table" name="product_data" id="product_data">
                        <thead>
                          <tr>
                            ...
                            <th class="span2" width="20%">Qty</th>
                          </tr>
                        </thead>
                        <tbody id="product_table_body">
                          <?php $i=0; foreach ($items as  $key) { ?>
                            <tr>
                              ...
                              <td><input type="number" class="form-control text-center" value="<?php echo $key->received_quantity ?>" data-rule="quantity" name='qty' id='qty' min="1">
                              </td>
                            </tr>
                          <?php $i++; } ?>
                        </tbody>
