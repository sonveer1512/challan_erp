                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <select class="form-control select2" id="user_id" name="user_id" style="width: 100%;" readonly>
                        ...
                        <tbody id="product_table_body">
                          <?php $i=0; foreach ($items as  $key) { ?>
                            <tr>
                              ...
                              <td><input type="number" class="form-control text-center" value="<?php if($key->received_quantity != 0) { echo $key->received_quantity; }else{ echo $key->quantity; } ?>" data-rule="quantity" name='received_qty[]' id='received_qty' min="1">
                              </td>
                            </tr>
                          <?php $i++; } ?>
                        </tbody>
