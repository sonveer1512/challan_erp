	      	...
	      	<div class="col-md-12">
		        <div class="box">
		            ...
		            <div class="box-body">
					    ...
					    <table id="table2">
					        <tr>
					            <td style="width: 50%; border-right: 1px solid ">FROM:- <?php echo $data[0]->dispatch_from; ?> </td>
					            <td style="width: 50%; text-align: right">DESTINATION:- <?php echo $data[0]->dispatch_to; ?> </td>
					        </tr>
					    </table>
		            		...
		            		<tbody>
		            			<?php $i = 1; $total = $weight = $quantity = 0;
                                  ...
                                  <tr>
                                      ...
                                      <td><?= $value->rent_product_description ; ?></td>
                                      <td>No Data.</td>
		            			...
		            			<?php  } else { ?>
                                  <tr>
                                      ...
                                      <td align="center"><?php $weight = $weight +  (int) (filter_var($value->weight, FILTER_SANITIZE_NUMBER_INT)); ?></td>
