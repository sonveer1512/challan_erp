      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-sm btn-info pull-right" href="<?php echo base_url('branch/add');?>" title="Add New Branch" onclick=""><!-- Add New Branch --> <?php echo $this->lang->line('branch_label_newbranch'); ?></a>
              <a class="btn btn-sm btn-info pull-right bg-orange" style="margin-right: 10px;" href="<?php echo base_url('warehouse/index');?>" title="Go to Warehouse" onclick="">Go to Warehouse  <?php //echo $this->lang->line('branch_label_newbranch'); ?></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
